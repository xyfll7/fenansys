...
let mongoURI = `mongodb://xyf:yangqi7'@148.70.143.157:27028/xinjiangfy?authSource=xyf&replicaSet=rep`
...
if (process.env.NODE_ENV === 'production') {
  ...
  mongoURI = "mongodb://xyf:yangqi7'@localhost:27017,localhost:27018,localhost:27019/xinjiangfy?replicaSet=rep&authSource=xyf&ssl=true"
}
